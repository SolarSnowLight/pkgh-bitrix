<?php
$GLOBALS['APPLICATION']->SetAdditionalCSS('/bitrix/components/college/about_us/templates/.default/css/about-us.css');
?>
    ...
    <div class="content">
            ...
            <div class="about-us">
                ...
                <div class="about-us-info__box-1">
                    <div class="about-us-info__box-image">
                        <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-2-1.png" alt="">
                    </div>
                    <div class="about-us-info__box-text">
                        <p> Колледж образован путем объединения 4 старейших учебных заведений среднего профессионального
                            образования Санкт-Петербурга 23 января 2006 года Постановлением Правительства
                            Санкт-Петербурга №38: </p>
                        <ul>
                        ...
                        <p><b> Учредителем</b> колледжа является Санкт-Петербург в лице Комитета по управлению городским
                            имуществом. Колледж находится в ведении - Комитета по науке и высшей школе Санкт-Петербурга.
                        </p>
                    </div>
                </div>
                ...
                <div class="about-us-info__box-1">
                    <div class="about-us-info__box-text">
                        <p> Колледж ведет образование по 19 специальностям, затрагивающим многие отрасли современной
                            промышленности и экономической деятельности города.</p>
                        <p>Особенностью образовательной деятельности в колледже является максимальная подготовка
                            выпускников к ведению производства на предприятиях. Наибольшее внимание уделяется
                            практической подготовке специалистов, которая обеспечивается мощнейшей
                            материально-технической базой и оснащением лабораторий и мастерских колледжа.</p>
                    </div>
                    <div class="about-us-info__box-image">
                        <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-2-2.png" alt="">
                    </div>
                </div>

                <div class="about-us-info__box-1">
                    <div class="about-us-info__box-image">
                        <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-2-3.png" alt="">

                    </div>
                    <div class="about-us-info__box-text">
                        <p>С сентября 2010 года учебные занятия начали проводиться в новом здании колледжа.
                            Здание построено согласно последним нормам и стандартам строительства учебных заведений.
                            Общая площадь здания составляет около 20 000 квадратных метров. </p>
                        <p> В здании колледжа находится библиотека с читальным залом, большой спортивный зал и бассейн.
                            На прилегающей территории имеется спортивная площадка с футбольным и волейбольным полем. Это
                            обеспечивают здоровье и активную внеклассную деятельность студентов.</p>
                        <p> Колледж оснащен новыми компьютерными классами и учебными лабораториями и мастерскими с
        ...
        <span>
         ...
         <p> <b> Учредителем</b> колледжа является Санкт-Петербург в лице Комитета по управлению городским имуществом. Колледж находится в ведении - Комитета по науке и высшей школе Санкт-Петербурга.</p>
                    ...
                    <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-compact-1.png" alt="">
          ...
          <p>Особенностью образовательной деятельности в колледже является максимальная подготовка выпускников к ведению производства на предприятиях. Наибольшее внимание уделяется практической подготовке специалистов, которая обеспечивается мощнейшей материально-технической базой и оснащением лабораторий и мастерских колледжа.</p>
                    ...
                    <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-compact-2.png" alt="">
          ...
          <p>С сентября 2010 года учебные занятия начали проводиться в новом здании колледжа.
            ...
            Студенты занимаются в новых просторных и светлых кабинетах.
                    ...
                    <img src="/bitrix/components/college/about_us/templates/.default/img/about-us-info__box-compact-3.png" alt="">
