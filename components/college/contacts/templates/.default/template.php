<?php
    $GLOBALS['APPLICATION']->SetAdditionalCSS('/bitrix/components/college/contacts/templates/.default/css/contacts.css');
?>
        ...
        <div class="contacts">
            <div class="contacts-map">
                ...
                <div class="contacts-map__addres">
                    <img src="/bitrix/components/college/contacts/templates/.default/img/contacts-map__addres.png" alt="">
            ...
            Представительств и филиалов колледж не имеет.</span>
                            <span><img src="/bitrix/components/college/contacts/templates/.default/img/ic_local_phone_48px.png" alt="">576-06-75</span>
                            <span><img src="/bitrix/components/college/contacts/templates/.default/img/ic_mail_outline_48px.png" alt="">pkgh@pkgh.edu.ru</span>
                            <span><img src="/bitrix/components/college/contacts/templates/.default/img/ic_schedule_48px.png" alt=""> Пн - Чт с 9:00 до 17:50, Пт с 9:00 до 16:50</span>
                            <span><img src="/bitrix/components/college/contacts/templates/.default/img/ic_place_48px.png" alt="">197373, СПб, пр. Авиаконструкторов, д.28 лит.А.</span>
            ...
            <div class="accordion-box">
              ...
              <span class="H1 color-sapphire_10">Санкт-Петербургское государственное бюджетное профессиональное образовательное учреждение «Политехнический колледж городского хозяйства»
                ...
                тел/факс: 576-06-75
                            ...
                            <div class="H1  body_thin"><a class="link-sapphire_30" href="#"><img src="/bitrix/components/college/contacts/templates/.default/img/contact/ic_file_download_48px.png" alt="">Скачать квитанцию на оплату обучения (для оплаты через Сбер банк)</a></div>
                            <div class="H1  body_thin"><a class="link-sapphire_30" href="#"><img src="/bitrix/components/college/contacts/templates/.default/img/contact/ic_file_download_48px.png" alt="">Скачать квитанцию на оплату услуг (для оплаты через Сбер банк)</a></div>
                            <div class="H1  body_thin"><a class="link-sapphire_30" href="#"><img src="/bitrix/components/college/contacts/templates/.default/img/contact/ic_file_download_48px.png" alt="">Скачать квитанцию на оплату обучения (при оплате в других банках)</a></div>
                            <div class="H1  body_thin"><a class="link-sapphire_30" href="#"><img src="/bitrix/components/college/contacts/templates/.default/img/contact/ic_file_download_48px.png" alt="">Скачать квитанцию на оплату услуг (при оплате в других банках)</a></div>
                            <div class="H1  body_thin"><a class="link-sapphire_30" href="#"><img src="/bitrix/components/college/contacts/templates/.default/img/contact/ic_file_download_48px.png" alt="">Скачать образец платежного поручения</a></div>
                        </div>
                    </div>
                </details>
            </div>
